...
<div class="span3 well" style="text-align: left;">
    <ul class="nav nav-list">			
		...
		<li><?php echo $this->Form->postLink('<i class="icon-remove"></i>Eliminar', array('action' => 'delete', $this->Form->value('Empleado.id')), array('escape'=>false), __('Realmente desea eliminar el Id %s?', $this->Form->value('Empleado.id'))); ?></li>
...
<div class="span6" style="text-align: left;">
    <h1><?php printf('Edit %s','Empleado'); ?></h1>
    <div class="empleados form"><?php
		echo $this->Form->create('Empleado',array('onsubmit'=>'return checkSubmit();','class'=>'form-horizontal'));?>
	        <fieldset>
	            ...
	            <?php
				echo $this->Form->input('id',array('between'=>'<div class="controls">','after'=>'</div>','label'=>array('class'=>'control-label'),'div'=>array('class'=>'control-group')));
				...
				echo $this->Form->input('Deduccione',array('between'=>'<div class="controls">','after'=>'</div>','label'=>array('class'=>'control-label'),'div'=>array('class'=>'control-group')));
				echo $this->Form->input('Obligacione',array('between'=>'<div class="controls">','after'=>'</div>','label'=>array('class'=>'control-label'),'div'=>array('class'=>'control-group')));
				echo $this->Form->input('Percepcione',array('between'=>'<div class="controls">','after'=>'</div>','label'=>array('class'=>'control-label'),'div'=>array('class'=>'control-group')));
				?>
		    </fieldset><?php
